...
export default function Hero() {
    ...
    return (
        <div className="relative h-screen mb-16 w-[100vw] ">
            ...
            <div className="box absolute inset-0 z-10 flex items-center self-center justify-self-center px-4">
                <div className="in_box relative z-10 flex flex-col items-center justify-center text-center">
                    <div className="bg-background/30 backdrop-blur-sm p-8 rounded-lg">
                        ...
                        <p className="text-xl md:text-2xl mb-8 max-w-2xl">
                            AI-ML Enthusiast and Creative Developer
                        </p>
